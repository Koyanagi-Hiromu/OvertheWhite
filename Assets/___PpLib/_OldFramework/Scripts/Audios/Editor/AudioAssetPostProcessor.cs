...
namespace SR
{
    ...
    {
        private static readonly string AUDIOCLIP_FOLDER = "Audios/";
        private static readonly string BGM = "BGMs";
        private static readonly string SE = "SEs";
        ...
        private void OnPostprocessAudio(AudioClip audioClip)
        {
            ...
            //SE系は全部モノラル化//
            audioImporter.forceToMono = path.Contains(SE);
