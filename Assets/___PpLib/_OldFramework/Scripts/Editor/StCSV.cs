...
namespace SR
{
    ...
    /// </summary>
    public static class StCSV
    {
        public static bool justLoad;
        ...
        // public static IEnumerator ErLoadCSV(string url, string name, Action<CsvData> act)
        // {
        //     var rowList = new List<List<string>>();
        //     yield return ErLoadCSV(url, rowList);

        //     var fieldNames = rowList.RemoveHead(); // 一行目は各フィールドの名前
        //     if (justLoad)
        //     {
        //         // new CsvData(name, fieldNames, rowList).FLog();
        //     }
        //     else
        //     {
        //         // act(new CsvData(name, fieldNames, rowList));
        //     }
        // }

        static IEnumerator ErLoadCSV(string url, List<List<string>> list)
        {
            using (WWW www = new WWW(url))
            {
                yield return www;
                var text = www.text;
                var parsedText = ParseCSV(text);
                parsedText.ForEach(pt => list.Add(pt));
            }
        }
        ...
        static List<List<string>> ParseCSV(string src)
        {
