...
namespace SR
{
    public static class IEnumerableExtensions
    {
        ...
        public static bool ContainsIndex<T>(this List<T> list, int value)
        {
        ...
        public static T WrapAt<T>(this IEnumerable<T> self, int index)
        {
            return self.ElementAt(UtilMath.Wrap(index, self.Count()));
        }
