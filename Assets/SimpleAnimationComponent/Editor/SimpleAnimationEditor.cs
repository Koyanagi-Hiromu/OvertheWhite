...
public class SimpleAnimationEditor : Editor
{
    static class Styles
    {
        ...
        public static GUIContent animateUpdateMode = new GUIContent("Animate Physics", "If checked, animations will be updated at the same frequency as Fixed Update");
    ...
    SerializedProperty animateUpdateMode;
    ...
    void OnEnable()
    {
        ...
        animateUpdateMode = serializedObject.FindProperty("m_AnimateUpdateMode");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(animateUpdateMode, Styles.animateUpdateMode);
