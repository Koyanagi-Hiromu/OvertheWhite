...
public class SimpleAnimationProxy : MonoBehaviour, IAnimation
{
    ...
    {
        get { return impl.animateUpdateMode == AnimatorUpdateMode.AnimatePhysics; }
        set { impl.animateUpdateMode = value ? AnimatorUpdateMode.AnimatePhysics : AnimatorUpdateMode.Normal; }
    }
