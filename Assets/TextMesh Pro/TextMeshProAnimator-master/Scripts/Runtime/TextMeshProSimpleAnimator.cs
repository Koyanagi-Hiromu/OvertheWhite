...
public class TextMeshProSimpleAnimator : MonoBehaviour
{
    ...
    public float delaySecForTriggerFinishEvent;
    public UnityEvent onEachFinish;
    ...
    public void Finish()
    {
        ...
        DG.Tweening.DOVirtual.DelayedCall(delaySecForTriggerFinishEvent, onEachFinish.Invoke);
    }
